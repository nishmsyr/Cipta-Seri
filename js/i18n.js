...
const TRANSLATIONS = {
  ...
  ms: {
    ...
    'gp.cap.1': 'Ruang Tamu — Kediaman Seksyen 7',
    'gp.cap.2': 'Naik Taraf Fasad — Denai Alam',
    'gp.cap.3': 'Kabinet Dapur — Bukit Rimau',
    'gp.cap.4': 'Kerja Tambahan — Kota Kemuning',
    'gp.cap.5': 'Perabot Pejabat Rumah — Setia Alam',
    'gp.cap.6': 'Kerja Pagar Keluli — Puncak Alam',
    'gp.cap.7': 'Binaan Almari — Alam Impian',
    'gp.cap.8': 'Unit Peruncitan — Glenmarie',
    'gp.cap.9': 'Bilik Solat — Kediaman Peribadi',
